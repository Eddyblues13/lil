...
<head>
    ...
    <title>Reset Password - cytopiacapitalpro</title>
                ...
                <div class="main-card-signin d-md-flex wd-100p">
                    <div class="wd-md-50p login d-none d-md-block page-signin-style p-5 text-white">
                        <div class="my-auto authentication-pages">
                            <div>
                                ...
                                <h5 class="mb-4">Create a New Password</h5>
                                <p class="mb-4">Enter your new password and confirm it to regain access to your account.
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="sign-up-body wd-md-50p">
                        <div class="main-signin-header">
                            ...
                            <form id="resetPasswordForm" method="POST" class="signup-form">
                                @csrf
                                ...
                                <button type="submit" class="btn btn-main-primary btn-block">Reset Password</button>
                            </form>
                        </div>
                        ...
                        if (response.success) {
                            ...
                            if (response.errors) {
                                $.each(response.errors, function(key, value) {
                                    $('#' + key.replace('.', '-') + '-error').text(value[0]);
                                });
                            } else {
                                toastr.error(response.message || 'Unable to reset password. Please try again.');
                            }
                        }
                    },
